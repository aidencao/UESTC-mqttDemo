...
public class testClient {
	...
	/*public static MqttClient getClient() throws Exception {
		if(client == null) {
			init();
		}
	...
	/*public static void main(String[] args) throws Exception {
		...
		MqttClient client = new MqttClient(endpoint, "java_device");
		client.connect(options);
		...
		// 模拟发送开门信息
		while (true) {
			System.out.println("模拟发送开门消息。。。。。。");
			System.out.println("请输入目标售货机编号：");
